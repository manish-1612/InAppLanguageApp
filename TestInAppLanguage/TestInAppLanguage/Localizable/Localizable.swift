...
////////////////////////////////////////////////////////////////////
//DO NOT LOCALIZE STORYBOARDS, SET ALL STRING FROM VIEW CONTROLLER//
////////////////////////////////////////////////////////////////////
...
enum AppNotification: String, NotificationName{
...
enum Language: String {
    ...
    var semantic: UISemanticContentAttribute {
        switch self {
        case .english, .chineese, .portuguese, .dutch:
    ...
    static var language: Language {
        ...
        set {
            ...
            if language.semantic == newValue.semantic{
                //semantic is same, so just fire notification
                
                //change language in the app, the language will be changed after restart
                ...
                //fire notification
                NotificationCenter.default.post(name: AppNotification.language.name, object: nil)

            }else{
                //semantic is changed, so restart the app
                ...
                //initialize the app from scratch and show initial view controller so it seems like the is restarted
